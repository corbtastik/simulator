// Routes repair_started events to business_events collection
const CATEGORY    = "business";
const TARGET_COLL = "business_events";
...
sp.createStreamProcessor("repair_started_business", pipeline);
sp.repair_started_business.start();
