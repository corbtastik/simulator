// Routes repair_started events to federal_events collection
const CATEGORY    = "federal";
const TARGET_COLL = "federal_events";
...
sp.createStreamProcessor("repair_started_federal", pipeline);
sp.repair_started_federal.start();
