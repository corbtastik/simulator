// ----- CHANGE THESE TWO PER EVENT & PROCESSOR -----
const CATEGORY    = "infrastructure";         // "business" | "consumer" | "federal" | "emerging_tech"
const TARGET_COLL = "infrastructure_events";  // match the category above
// --------------------------------------------------
...
// sp.process(pipeline);
sp.createStreamProcessor("infrastructure_events", pipeline);
sp.infrastructure_events.start();
